...
if desired. You can open the Side Nav initially by setting the `initiallyIsOpen` attribute to `true`. In push mode this component is designed to
...
<Preview>
  <Story name='Push' height='350px'>{{
    template: `
      <mui-root-container>
        <mui-side-nav #sideNav initiallyIsOpen="true">
          <li>
            <div class="user-view">
...
<Preview>
  <Story name='Push below App Bar' height='350px'>{{
    template: `
      <mui-root-container>
        <mui-app-bar (mainMenuTap)="sideNav.toggle()"></mui-app-bar>
        <mui-side-nav #sideNav mode="pushBelowAppBar" initiallyIsOpen="true">
          <li>
            <div class="user-view">
              <div class="background">
                <img src="https://place-hold.it/300x176/999">
...
<Preview>
  <Story name='Overlay' height='350px'>{{
    template: `
      <mui-root-container>
        <mui-side-nav #sideNav mode="overlay" initiallyIsOpen="true">
          <li>
            <div class="user-view">
              <div class="background">
                <img src="https://place-hold.it/300x176/999">
